...
class Home {
    ...
    pageAnimations() {
        ...
        (0, _gsapDefault.default).to(".cycle-image-container", {
            scrollTrigger: {
...
var o = /*#__PURE__*/ function() {
    ...
    return e.advance = function(t) {
        ...
        if (this.isRunning) {
            var o, n = !1;
            if (this.lerp) this.value = (1 - (o = this.lerp)) * this.value + o * this.to, Math.round(this.value) === this.to && (this.value = this.to, n = !0);
            else {
                this.currentTime += t;
                var s = i(0, this.currentTime / this.duration, 1), r = (n = s >= 1) ? 1 : this.easing(s);
...
var s = /*#__PURE__*/ function() {
    function t(t, e) {
        ...
        }, this.wrapper = t, this.content = e, this.wrapper === window ? (window.addEventListener("resize", this.onWindowResize, !1), this.onWindowResize()) : (this.wrapperResizeObserver = new ResizeObserver(n(this.onWrapperResize, 100)), this.wrapperResizeObserver.observe(this.wrapper), this.onWrapperResize()), this.contentResizeObserver = new ResizeObserver(n(this.onContentResize, 100)), this.contentResizeObserver.observe(this.content), this.onContentResize();
    }
    ...
    function t(t, e) {
        var o = this, n = e.wheelMultiplier, s = void 0 === n ? 1 : n, r = e.touchMultiplier, l = void 0 === r ? 2 : r, h = e.normalizeWheel, a = void 0 !== h && h;
        this.onTouchStart = function(t) {
            var e = t.targetTouches ? t.targetTouches[0] : t, i = e.pageY;
            o.touchStart.x = e.pageX, o.touchStart.y = i;
        }, this.onTouchMove = function(t) {
            var e = t.targetTouches ? t.targetTouches[0] : t, i = e.pageX, n = e.pageY, s = -(i - o.touchStart.x) * o.touchMultiplier, r = -(n - o.touchStart.y) * o.touchMultiplier;
            o.touchStart.x = i, o.touchStart.y = n, o.emitter.emit("scroll", {
                type: "touch",
                deltaX: s,
                deltaY: r,
                event: t
            ...
            o.normalizeWheel && (e = i(-100, e, 100), n = i(-100, n, 100)), o.emitter.emit("scroll", {
                type: "wheel",
                deltaX: e *= o.wheelMultiplier,
                deltaY: n *= o.wheelMultiplier,
                event: t
            });
    ...
    function t(t) {
        var e = this, i = void 0 === t ? {} : t, n = i.direction, l = i.gestureDirection, h = i.mouseMultiplier, a = i.smooth, c = i.wrapper, u = void 0 === c ? window : c, p = i.content, d = void 0 === p ? document.documentElement : p, v = i.wheelEventsTarget, m = void 0 === v ? u : v, f = i.smoothWheel, g = void 0 === f ? null == a || a : f, w = i.smoothTouch, S = void 0 !== w && w, y = i.duration, z = i.easing, M = void 0 === z ? function(t) {
            return Math.min(1, 1.001 - Math.pow(2, -10 * t));
        } : z, b = i.lerp, T = void 0 === b ? y ? null : .1 : b, E = i.infinite, W = void 0 !== E && E, L = i.orientation, R = void 0 === L ? null != n ? n : "vertical" : L, _ = i.gestureOrientation, O = void 0 === _ ? null != l ? l : "vertical" : _, k = i.touchMultiplier, H = void 0 === k ? 2 : k, x = i.wheelMultiplier, C = void 0 === x ? null != h ? h : 1 : x, X = i.normalizeWheel, Y = void 0 !== X && X;
        this.onVirtualScroll = function(t) {
            var i = t.type, o = t.deltaX, n = t.deltaY, s = t.event;
            if (!s.ctrlKey && !("vertical" === e.options.gestureOrientation && 0 === n || "horizontal" === e.options.gestureOrientation && 0 === o || s.composedPath().find(function(t) {
                ...
                if (e.isStopped || e.isLocked) s.preventDefault();
                    ...
                    s.preventDefault();
                    var r = n;
                    "both" === e.options.gestureOrientation ? r = Math.abs(n) > Math.abs(o) ? n : o : "horizontal" === e.options.gestureOrientation && (r = o), e.scrollTo(e.targetScroll + r, {
                        programmatic: !1
                    });
                }
            }
            ...
            wheelMultiplier: C,
            normalizeWheel: Y
        }, this.dimensions = new s(u, d), this.rootElement.classList.add("lenis"), this.velocity = 0, this.isStopped = !1, this.isSmooth = g || S, this.isScrolling = !1, this.targetScroll = this.animatedScroll = this.actualScroll, this.animate = new o, this.emitter = {
            events: {},
            emit: function(t) {
                for(var e = this.events[t] || [], i = 0, o = e.length; i < o; i++)e[i].apply(e, [].slice.call(arguments, 1));
            },
    ...
    return n.destroy = function() {
        ...
        if (!this.isStopped || void 0 !== S && S) {
            if ([
                ...
                var M, b;
                if ("string" == typeof t ? b = document.querySelector(t) : null != (M = t) && M.nodeType && (b = t), b) {
            ...
            if ("number" == typeof t) {
                if (t += r, t = Math.round(t), this.options.infinite ? z && (this.targetScroll = this.animatedScroll = this.scroll) : t = i(0, t, this.limit), h) return this.animatedScroll = this.targetScroll = t, this.setScroll(this.scroll), this.reset(), this.emit(), void (null == w || w());
                if (!z) {
                ...
                this.animate.fromTo(this.animatedScroll, t, {
                    ...
                    onUpdate: function(t, e) {
                        var i = e.completed;
                        c && (o.isLocked = !0), o.isScrolling = !0, o.velocity = t - o.animatedScroll, o.direction = Math.sign(o.velocity), o.animatedScroll = t, o.setScroll(o.scroll), z && (o.targetScroll = t), i && (c && (o.isLocked = !1), requestAnimationFrame(function() {
                            o.isScrolling = !1;
                        }), o.velocity = 0, null == w || w()), o.emit();
                    }
                });
            }
        }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d0drb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _splitting = require("splitting");
var _splittingDefault = parcelHelpers.interopDefault(_splitting);
...
exports.default = (0, _splittingDefault.default);

},{"splitting":"77jB6","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"77jB6":[function(require,module,exports) {
...
},{}],"3uR7n":[function() {},{}],"7jeGL":[function() {},{}]},["9tRox","1SICI"], "1SICI", "parcelRequire9b42")
